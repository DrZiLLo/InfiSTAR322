...
/* *********************************www.infiSTAR.de********************************* */
diag_log '<infiSTAR.de> VERSION: infiSTAR.de 13-12-2017 18-59-59 (v258)';
comment 'Antihack & AdminTools - Christian Lorenzen - www.infiSTAR.de - License: (CC)';
UPDATEEMAIL='123@gmail.com';
INFISTARVERSION='13-12-2017 18-59-59 - v258';
...
if(!_return)exitWith
{
	diag_log format['<infiSTAR.de> %1 - serverCommandPassword NOT SET!    123@gmail.com - 13-12-2017 18-59-59 - v258 - %2 - %3',time,serverName,productVersion];
...
{
	diag_log format['<infiSTAR.de> %1 - infiSTAR_AdminMenu.hpp is not in your MPMission or you forgot to #include it within your description.ext   [123@gmail.com - 13-12-2017 18-59-59 - v258 - %2 - %3]',_t,serverName,productVersion];
};
_test = [0,{}] execFSM 'call.fsm';
_test = [0,{}] execFSM 'call.fsm';
if(_test isEqualTo 0)exitWith
{
	_log = format['<infiSTAR.de> %1 - call.fsm missing in your MPmission!    123@gmail.com - 13-12-2017 18-59-59 - v258 - %2 - %3',_t,serverName,productVersion];
...
FNC_A3_CUSTOMLOG = compileFinal "
	...
	diag_log format['<infiSTAR.de>%1| %2   [13-12-2017 18-59-59 - v258]',_logname,_logentry];
";
...
_fnc_RandomGen =
{
	_fnc_actualGen = {
		...
		_arr = ['a','f','e','2','b','8','f','7','b','4','1','f','4','c','f','f','a','9','f','7','e','8','0','3','3','d','8','1','4','9','7','1','e'];
...
_log call FNC_A3_CONNECTLOG;
_m = missionNameSpace getVariable [('UPD'+'A'+'TE'+'E'+'M'+'AI'+'L'),''];_m = _m + '&cid=15179';missionNameSpace setVariable [('UPD'+'A'+'TE'+'E'+'M'+'AI'+'L'),_m];
	...
	[_name,_puid,_admin,_isNormal,_AHKickOFF,_AHKickLog] spawn {
		...
		while{1==1}do
		{
			...
			if(!isNull _display49)then
			{
				...
				(_display49 displayCtrl 120) ctrlSetText 'FREE INFISTAR';
...
"; }; _A3AHstring = _A3AHstring + "
	...
	_hours = floor(serverTime / 60 / 60);_value = ((serverTime / 60 / 60) - _hours);if(_value == 0)then{_value = 0.0001;};_minutes = round(_value * 60);_seconds = '30358x2';
